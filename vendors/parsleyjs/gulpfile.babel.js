...
function buildDoc(done) {
  ...
  docco.document({
    ...
    args: sources
      ...
      .pipe($.replace('<div id="jump_page">', '<div id="jump_page"><a class="source" href="../AdminLogin.php"><<< back to documentation</a>'))
...
function writeVersion() {
  return gulp.src(['AdminLogin.php', 'doc/download.html', 'README.md'], { base: "./" })
