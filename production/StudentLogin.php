                ...
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <div class="mb-md-5 mt-md-3 pb-5">
                            ...
                            <p class="text-white-50 mb-5">Student Login</p>
                            <form action="check.php" method="post">
                                ...
                                <input class="btn btn-outline-light btn-lg px-5"
                                        type="submit" value="Login" name="checkStudent">
                            </form>
                            <br>
                            <p>Dont have an account? <a href="registerFormStudent.php">Register now</a></p>
                        </div>
                    </div>
                </div>
            </div>
